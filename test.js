...
var _user$project$Components_News_Messages$ShowNews = {ctor: 'ShowNews'};

var _user$project$Components_News_Models$News = F5(
	function (a, b, c, d, e) {
		return {id: a, date: b, title: c, content: d, image: e};
	});
...
var _user$project$Router$ProductsRoute = {ctor: 'ProductsRoute'};
var _user$project$Router$NewsRoute = {ctor: 'NewsRoute'};
...
var _user$project$Router$matchers = _elm_lang$core$Native_List.fromArray(
	[
		...
		A2(_sporto$hop$Hop_Matchers$match1, _user$project$Router$NewsRoute, '/news'),
		A2(_sporto$hop$Hop_Matchers$match1, _user$project$Router$ProductsRoute, '/products')
	]);
var _user$project$Router$routerConfig = {hash: true, basePath: '', matchers: _user$project$Router$matchers, notFound: _user$project$Router$NotFoundRoute};
var _user$project$Router$navigationCmd = function (path) {
	return _elm_lang$navigation$Navigation$modifyUrl(
		A2(_sporto$hop$Hop$makeUrl, _user$project$Router$routerConfig, path));
};
var _user$project$Router$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: _user$project$Router$navigationCmd(_p0._0)
		};
	});
...
var _user$project$Components_News_Update$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: _user$project$Router$navigationCmd('/news')
		};
	});

var _user$project$Components_Productos_Models$Product = F5(
	function (a, b, c, d, e) {
		return {id: a, image: b, title: c, description: d, price: e};
	});

var _user$project$Model$initialModel = F2(
	function (location, route) {
		return {
			routing: A2(_user$project$Router$Model, location, route),
			products: _elm_lang$core$Native_List.fromArray(
				[]),
			news: _elm_lang$core$Native_List.fromArray(
				[])
		};
	});
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {routing: a, products: b, news: c};
	});

var _user$project$TestRunner$nextModel = function (initialModel) {
	return initialModel;
};
var _user$project$TestRunner$runShowNews = function () {
	var _p0 = A2(_user$project$Components_News_Update$update, _user$project$Components_News_Messages$ShowNews, _user$project$Model$initialModel);
	var model = _p0._0;
	var cmd = _p0._1;
	return model;
}();
var _user$project$TestRunner$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				_user$project$TestRunner$runShowNews,
				_user$project$TestRunner$nextModel(_user$project$Model$initialModel)))
		]));
var _user$project$TestRunner$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$TestRunner$tests)
};

var Elm = {};
Elm['TestRunner'] = Elm['TestRunner'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TestRunner'], 'TestRunner', typeof _user$project$TestRunner$main === 'undefined' ? null : _user$project$TestRunner$main);
